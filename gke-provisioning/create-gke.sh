...
--no-enable-basic-auth --cluster-version "1.14.8-gke.12" --machine-type "n1-standard-2" --image-type "COS" \
...
--subnetwork "projects/pa-afa-kubernetes/regions/europe-west3/subnetworks/default" \
